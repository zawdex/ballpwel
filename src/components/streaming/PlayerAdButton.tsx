...
const PlayerAdButton = () => {
  ...
  return (
    <>
      ...
      {showCard && (
        <div
          className="absolute top-3 right-14 z-50 w-56 rounded-xl bg-card/95 backdrop-blur-md border border-border/60 shadow-2xl overflow-hidden animate-fade-in"
